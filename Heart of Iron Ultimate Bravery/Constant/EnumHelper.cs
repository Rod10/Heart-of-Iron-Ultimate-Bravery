...
namespace Heart_of_Iron_Ultimate_Bravery.Constant
{
    ...
    {
        public static T[] GetEnumArrayForMod<T>(string modName) where T : Enum
        {
        ...
        private static TankType[] GetTankTypesForMod(string modName)
        {
            return modName.ToLower() switch
            {
                ...
                // "kaiserreich" => ModConstants.TankTypes.Kaiserreich,
                // "road56" => 
                "millenniumdawn" => ModConstants.TankTypes.MillenniumDawn,
        ...
        {
            var validEnums = GetEnumArrayForMod<T>(modName);

...
namespace Heart_of_Iron_Ultimate_Bravery.Constant
{
  public static class ModConstants
  {
    ...
    public static class ShipTypes
    {
      ...
      {
        ShipType.Destroyer, ShipType.Cruiser, ShipType.Battleship, ShipType.Carrier, ShipType.Submarine,
      };
    ...
    public static class TankTypes
    {
      ...
      {
        TankType.Light, TankType.Medium, TankType.Heavy, TankType.SuperHeavy, TankType.Modern,
      };
    ...
    public static class PlaneTypes
    {
      ...
      {
        PlaneType.Fighter, PlaneType.CloseAirSupport, PlaneType.NavalBomber, PlaneType.TacticalBomber,
    ...
    {
      public static readonly DivisionType[] Vanilla = { DivisionType.Infantry, DivisionType.Armor };
    ...
    public static class TankVersions
    {
      public static readonly TankVersion[] Vanilla =
      {
        TankVersion.InterWar, TankVersion.Basic, TankVersion.Improved, TankVersion.Advanced,
      };
    }

    public static class ShipVersions
    {
      public static readonly ShipVersion[] Vanilla =
      {
